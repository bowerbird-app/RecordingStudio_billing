...
module RecordingStudioBilling
  ...
  ADMIN_OPERATION_AREAS = {
    ...
    billing_subscriptions: { section: "billing_operations", title: "Subscriptions", model: "Subscription",
                             filters: %i[state currency_code], columns: %i[identifier state currency_code] },
    ...
    billing_subscription_lines: { section: "billing_operations", title: "Plan lines",
                                  model: "SubscriptionLine", filters: %i[mode currency_code], columns: %i[line_key mode amount_minor currency_code] },
