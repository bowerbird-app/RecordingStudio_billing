...
module RecordingStudioBilling
  class RecoverTaxCalculation
    ...
    def self.call(calculation:)
      ...
      raise ArgumentError, "tax calculation is not ready for recovery" unless %w[pending unknown].include?(calculation.status) && calculation.corrections.empty?
      ...
      raise ArgumentError, "tax calculator mode does not match the original calculation" if calculator.capabilities.mode != command.calculator_mode || calculation.calculator_mode != command.calculator_mode
