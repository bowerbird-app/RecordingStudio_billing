...
module RecordingStudioBilling
  class RecoverFinancialCommand
    def self.call(command:, provider_key:, lease_duration: FinancialCommandClaim::DEFAULT_LEASE)
      ...
      recover_with_adapter(command:, adapter:, lease_duration:)
    end
    ...
    def self.recover_with_adapter(command:, adapter:, lease_duration:)
