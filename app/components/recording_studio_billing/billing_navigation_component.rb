    ...
    def default_items
      ...
      [
        ...
        { page: :subscriptions, label: "Plan", href: helpers.plan_billing_path(root_recording_id: root_id),
          icon: :credit_card },
        { page: :addons, label: "Addons", href: helpers.addons_billing_path(root_recording_id: root_id), icon: :plus },
        { page: :usage, label: "Usage & Credits", href: helpers.usage_billing_path(root_recording_id: root_id),
          icon: :chart_bar },
