...
class MakeRatedUsageSettlementsPeriodScoped < ActiveRecord::Migration[8.1]
  def up
    add_reference :recording_studio_billing_rated_usage_settlements, :usage_period, type: :uuid,
                                                                                    foreign_key: { to_table: :recording_studio_billing_usage_periods }
    change_column_null :recording_studio_billing_rated_usage_settlements, :rated_usage_id, true
    remove_index :recording_studio_billing_rated_usage_settlements, name: "idx_rs_billing_settlement_rated_usage"
    add_index :recording_studio_billing_rated_usage_settlements, :usage_period_id, unique: true,
                                                                                   name: "idx_rs_billing_usage_settlement_period"
